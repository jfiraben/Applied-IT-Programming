		...
		<div id="content">
			...
			<div id="lab3form">
				...
				<form action="" method="post">
					<p><label for="id_fname">First Name: </label><input id="id_fname" type="text" name="fname" />
					<label for="id_lname">Last Name: </label><input id="id_lname" type="text" name="lname" /><br/><br/>
					<label for="id_email">Email Address: </label><input id="id_email" type="text" name="email" /><br/><br/>
					<label for="id_pnum">Phone Number:  </label><input id="id_pnum" type="text" name="pnum" /><br/><br/>
					...
					<label for="id_zip">Zip: </label><input id="id_zip" type="text" name="zip" /><br/><br/></p>
					<div class="buttons">
						<p><input type="submit" value="Add Entry" name="add"/></p><br/>
					</div>
				</form>
				<?php
					}
