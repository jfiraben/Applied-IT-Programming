...
Jordan Firaben
IT 207 - 002
assignment4/indexdatabase.php File
-->
    ...
    <?php include '../menu.inc';?>
		<div id="content">
			<div id="lab4form">
				...
				<h1>Add Comments</h1>
				<hr/>
				<form action="addcommentsdatabase.php" method="post" id="addcommentsdatabase">
				...
				<br/>
				<h4>OR</h4>
				<a href="/~jfiraben/IT207/assignment4/index.php">Add comments using text file</a>
			</div>
		</div>
