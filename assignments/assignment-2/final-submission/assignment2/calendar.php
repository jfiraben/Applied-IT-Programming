    ...
    <?php include '../menu.inc';?>
		<div id="content">
				...
				<form action="" method="post">
					<p><label for="id_sname">Student Name: </label><input id="id_sname" type="text" name="sname" />
					<label for="id_semail">Student Email: </label><input id="id_semail" type="text" name="semail" />
					...
					<div class="calendar">
						...
						if(isset($_POST['Submit']))
						{
							$sname = $_POST['sname'];
							$semail = $_POST['semail'];
							$to = 'test@test.com'/*'mnachawa@gmu.edu'*/;
							$subject = 'Office Hours Sign Up Form';
							$message = 'You have received a reservation from ' . $sname;
							$headers = 'From: ' . $semail;

							$email = mail ($to, $subject, $message, $headers);
							$testemail = ($email) ? $testemail = "Email successfully sent from " . $_POST['semail'] : $testemail = "Message failed to send";

							if (isset($_POST['timeradio']) and isset($sname) and isset($semail))
							{
								echo $testemail;
							}
							else
							...
							if(isset($_POST['Submit']))
							{
								if (isset($_POST['timeradio']))
								{
									...
									if (strpos($timeradioselect, 'firmon') !==false)
									{
										...
										$divfirstrow .= '<br/>';
										$divfirstrow .= '<div class="radiosubmit">' . $timeradioselectpart . ' -- ' . $sname . '</div>';
									}
								}
								if(!empty($_POST["timesMon2"]))
								{
							...
							if(isset($_POST['Submit']))
							{
								if (isset($_POST['timeradio']))
								{
									...
									if (strpos($timeradioselect, 'sermon') !==false)
									{
										$timeradioselectpart = substr($timeradioselect,0,-6);
										$divsecondrow .= '<br/>';
										$divsecondrow .= '<div class="radiosubmit">' . $timeradioselectpart . ' -- ' . $sname . '</div>';
									}
								}
								if(!empty($_POST["timesMon2"]))
								{
							...
							if(isset($_POST['Submit']))
							{
								if (isset($_POST['timeradio']))
								{
									...
									if (strpos($timeradioselect, 'thrmon') !==false)
									{
										$timeradioselectpart = substr($timeradioselect,0,-6);
										$divthirdrow .= '<br/>';
										$divthirdrow .= '<div class="radiosubmit">' . $timeradioselectpart . ' -- ' . $sname . '</div>';
									}
								}
								if(!empty($_POST["timesMon2"]))
								{
							...
							if(isset($_POST['Submit']))
							{
								if (isset($_POST['timeradio']))
								{
									...
									if (strpos($timeradioselect, 'formon') !==false)
									{
										$timeradioselectpart = substr($timeradioselect,0,-6);
										$divfourthrow .= '<br/>';
										$divfourthrow .= '<div class="radiosubmit">' . $timeradioselectpart . ' -- ' . $sname . '</div>';
									}
								}
								if(!empty($_POST["timesMon2"]))
								{
							...
							if(isset($_POST['Submit']))
							{
								if (isset($_POST['timeradio']))
								{
									...
									if (strpos($timeradioselect, 'fifrmon') !==false)
									{
										...
										$divfifthrow .= '<br/>';
										$divfifthrow .= '<div class="radiosubmit">' . $timeradioselectpart . ' -- ' . $sname . '</div>';
									}
								}
								if(!empty($_POST["timesMon2"]))
								{
							...
							if(isset($_POST['Submit']))
							{
								if (isset($_POST['timeradio']))
								{
									...
									if (strpos($timeradioselect, 'sirmon') !==false)
									{
										$timeradioselectpart = substr($timeradioselect,0,-6);
										$divsixthrow .= '<br/>';
										$divsixthrow .= '<div class="radiosubmit">' . $timeradioselectpart . ' -- ' . $sname . '</div>';
									}
								}
								if(!empty($_POST["timesMon2"]))
								{
